...
# Naman's Robot Shop Install

Install Naman's Robot Shop on to your K8s cluster using the helm chart, see the [README](helm/README.md) for details of the various options.
...
You can apply resource quotas to the namespace where you installed Naman's Robot Shop.
...
Naman's Robot Shop will run on Kubernetes with Istio service mesh. Configure Istio ingress.
